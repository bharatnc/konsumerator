...
import (
	"github.com/kubernetes/autoscaler/vertical-pod-autoscaler/pkg/apis/autoscaling.k8s.io/v1"
...
func (in *InstanceState) DeepCopyInto(out *InstanceState) {
	*out = *in
	if in.LastScaleEvent != nil {
		in, out := &in.LastScaleEvent, &out.LastScaleEvent
		*out = new(metav1.Time)
		(*in).DeepCopyInto(*out)
	}
}
