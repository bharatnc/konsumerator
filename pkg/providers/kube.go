...
func (l *KubeLagSource) QueryConsumptionRate() (map[int32]int64, error) {
	return nil, nil
}
func (l *KubeLagSource) QueryProductionRate() (map[int32]int64, error) {
	return nil, nil
}
func (l *KubeLagSource) QueryProductionRateDistribution() (map[int32]int64, error) {
	return nil, nil
}
func (l *KubeLagSource) QueryOffset() (map[int32]int64, error) {
	return nil, nil
}
